      ...
      <div className="max-w-7xl mx-auto px-4 md:px-0 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {visibleTeam.map((member, index) => (
            <ScrollReveal key={member.name} delay={index * 150} type="fade-up">
              <div 
                onClick={() => handleNodeClick(member.slug)}
                className="cursor-pointer group relative aspect-[4/5] overflow-hidden bg-[#050505] border border-white/5 hover:border-[#00E5FF]/40 transition-all duration-500 h-full block"
              >
                {/* Profile Image */}
                <img
                  src={member.image}
